...
# 500 Internal server error, so from what model do we use objects.get (is it just by manupulating or requesting bad root url while in settings the allowed_hosts are already specified/limited?)
